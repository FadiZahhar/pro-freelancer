...
?>
    ...
    ?>
<a <?php echo $class; ?>href="<?php echo $item->flink; ?>#<?php echo str_replace(" ","_",$item->title); ?>" <?php echo $title; ?>  id="<?php echo str_replace(" ","_",$item->title); ?>"><?php echo str_replace($oldtxt, $newtxt, $linktype); ?><span class="seperator"><strong>|</strong></span><span class="position"> <?php echo $item->anchor_title ?></span></a><?php
		}
        break;
	case 1:
		// _blank
